...
/* Sets e to point to the index of the top and is similar to
 * the getLifo function, however does not move the top. Returns
 * 0 if successful and -1 if e is NULL. If q is empty, returns
 * -2 and sets *e to NULL. */
